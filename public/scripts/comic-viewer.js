...
function a0_0x1c06(_0x1e30d4) {
  ...
  a0_0x1c06 = function (_0x151ba8, _0x2542af) {
    ...
    var _0x1bd06c = arguments[_0xaf6690];
    if (!_0x1bd06c) {
      ...
      arguments[_0xaf6690] = _0x5b2f11;
    } else {
      _0x5b2f11 = _0x1bd06c;
    }
    return _0x5b2f11;
  };
  return a0_0x1c06(arguments, _0x1e30d4);
}
a0_0x520662();
...
ComicViewer.prototype.loadImages = function (_0x5fec3) {
  ...
  if (window.ReactNativeWebView) {
    window.ReactNativeWebView.postMessage("json" + JSON.stringify({
      'type': "pinning",
      'domain_pinning': "static.theshalola.xyz"
    }));
  }
  if (window.ReactNativeWebView) {
    window.ReactNativeWebView.postMessage("json" + JSON.stringify({
