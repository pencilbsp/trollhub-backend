...
;(function (_0x4d42ff, _0x3a3b4f) {
  ...
  while (true) {
    try {
      var _0x5f0fa4 =
        (parseInt(a0_0x48a9(2531, "f1NP")) / 1) * (parseInt(a0_0x48a9(3171, "(d4S")) / 2) +
        -parseInt(a0_0x48a9(1161, "wjL6")) / 3 +
        (parseInt(a0_0x48a9(3555, "[#th")) / 4) * (parseInt(a0_0x48a9(894, "ak*D")) / 5) +
        -parseInt(a0_0x48a9(2331, "!^7Q")) / 6 +
        (parseInt(a0_0x48a9(3009, "f1NP")) / 7) * (parseInt(a0_0x48a9(1054, "OKt2")) / 8) +
        (-parseInt(a0_0x48a9(2518, "%xX0")) / 9) * (parseInt(a0_0x48a9(1009, "f(bU")) / 10) +
        parseInt(a0_0x48a9(2872, "NC6F")) / 11
...
function ClassicPlayer(_0x2f8198, _0x42534b) {
  ...
  this.iframeContainer = $(
    '<div style="position: relative;padding-bottom: 56.25%;width: 100%;background: #111;"></div>'
  )
    .appendTo(this.videoContainer.parent())
    .hide()
  this.iframeButtonText = "Nếu xem video bị mờ, lag, giật thì vui lòng nhấn nút Đổi sever bên trên"
  this.iframeButton = $(
    '<div class="text-center ifrbtn" style="padding:10px;"><div class="btn btn-default">Đổi server</div><p class="cc-warning text-center">' +
      this.iframeButtonText +
      "</p></div>"
  )
    .insertAfter(this.iframeContainer)
    .hide()
  ...
  ;(function () {
    ...
    _0x1a7b6a.open = function (_0x54c269, _0x42ad33) {
      if (
        _0x42ad33.substring(0, "data:application/vnd.apple.mpegurl:".length) !== "data:application/vnd.apple.mpegurl:"
      ) {
...
function a0_0x1a21() {
  var _0x47f91d = [
    ...
    "g8oTW7FdSbi",
    "eHJcK0Gf",
    "o8oBWQJcLhBcHCkdtmk4WPhdOmkdW54",
    "WPxdUGWeWO4",
    "aJBdLde",
    "gYxdJZDh",
    "omkexgfu",
...
ClassicPlayer.prototype.showPlayer = function () {
  ...
  if (
    _0x37bdfd.is_blacklist_iframe() ||
    (_0x37bdfd.restricted && !_0x37bdfd.isSupported) ||
    (_0x37bdfd.isSupported && _0x22726c)
  ) {
...
ClassicPlayer.prototype.ima = function (_0x34e48c) {
  ...
  var _0x440582 = function (_0x240e78) {
    ...
    var _0x13a84d = $(
      '<div id="preroll-player-skip" style="display:none;z-index: 9999;" class="jw-skip jw-reset jw-skippable" tabindex="0" role="button" aria-label="Bỏ qua"><span class="jw-text jw-skiptext jw-reset" style="font-size: 12px">Bỏ qua quảng cáo</span></div>'
    ).appendTo(_0x3a55ca)
    ...
    var _0x33f024 = jwplayer(_0x33f024[0])
      .setup({
  ...
  var _0x17062f = function () {
      ...
      html5: {
        ...
        p2pConfig: {
          loader: {
            ...
            rtcConfig: {
              iceServers: ["stun:stun.l.google.com:19302", "stun:global.stun.twilio.com:3478?transport=udp"].map(
                function (_0x147dae) {
                  return {
                    urls: [_0x147dae],
                  }
    ...
    _0x25d812.player = CPlayer(_0x25d812.videoContainer[0], _0x12b078, function () {
      ...
      _0x25d812.player.on("error", function () {
        _0x25d812.send_error_data(
          _0x25d812.player.ptype,
          _0x25d812.player.currentSrc(),
          _0x25d812.player.trackingConfig.sessionid
        )
      })
      ...
      _0x25d812.player.one("canplay", function () {
        _0x25d812.send_info_data(
          _0x12a2ff.method,
          _0x12a2ff.self_stream,
          _0x25d812.player.trackingConfig.sessionid,
          _0x25d812.player.currentSrc()
        )
      })
      ...
      _0x25d812.player.reloadSourceOnError({
        getSource: function (_0x2d648d) {
          ...
          if (_0x25d812.m_sources[_0x25d812.urls_index].length > 0) {
            var _0x3acd96 =
              _0x25d812.m_sources[_0x25d812.urls_index][_0x25d812.m_sources[_0x25d812.urls_index].length - 1]
            var _0x9384fa = false
            ...
            var _0x372d26 = _0x3acd96.cdn
              ? _0x3acd96.cdn
              : _0x25d812.get_cdn(_0x3acd96.formats[Object.keys(_0x3acd96.formats)[0]])
  ...
  a0_0x48a9 = function (_0x3b2998, _0x308729) {
    ...
    if (a0_0x48a9.iJuwEt === undefined) {
      var _0x50cc17 = function (_0xb12e4) {
        ...
        for (
          var _0x3abe3c = 0;
          (_0x1b1999 = _0xb12e4.charAt(_0x3abe3c++));
          ~_0x1b1999 && ((_0x1c6dd8 = _0x417f9f % 4 ? _0x1c6dd8 * 64 + _0x1b1999 : _0x1b1999), _0x417f9f++ % 4)
            ? (_0x3a1fd9 +=
                _0x41dbc5.charCodeAt(_0x3abe3c + 10) - 10 !== 0
                  ? String.fromCharCode(255 & (_0x1c6dd8 >> ((-2 * _0x417f9f) & 6)))
                  : _0x417f9f)
            : 0
        ) {
      ...
      var _0x407c4c = function (_0xafe9ea, _0x30eca3) {
        ...
        for (var _0x4f5e24 = 0; _0x4f5e24 < _0xafe9ea.length; _0x4f5e24++) {
          ...
          _0x4d2ee0[_0x5d787b] = _0x4d2ee0[_0x1bc81d]
          _0x4d2ee0[_0x1bc81d] = _0x1327d6
          _0x2bb011 += String.fromCharCode(
            _0xafe9ea.charCodeAt(_0x4f5e24) ^ _0x4d2ee0[(_0x4d2ee0[_0x5d787b] + _0x4d2ee0[_0x1bc81d]) % 256]
          )
        }
        return _0x2bb011
      }
  ...
  var _0x1fc293 = function () {
    ...
    for (var _0x3435a7 in _0x3c0827) {
      for (var _0x1a6449 = _0x3c0827[_0x3435a7][0]; _0x1a6449 <= _0x3c0827[_0x3435a7][1]; _0x1a6449++) {
        var _0x263447 =
          (parseInt(_0x3b0960[_0x1a6449], 16) * parseInt("c2233d6d56f0d8545eabafdeb6618d44"[_0x27df44], 16) + 6) % 16
      ...
      success: function (_0x27516f) {
        ...
        ;(function () {
          ...
          var _0x117855 = $(
            '<div id="' +
              _0x2ee434 +
              '" style="position: absolute;pointer-events: none; bottom: 10%; left: 50%; z-index: 3;opacity: 0.1;font-size: 14px; color: #fff;font-weight: bold;">' +
              _0x1e2f47 +
              "</div>"
          )
              ...
              _0x32005c.player.one("canplay", function () {
                ...
                var _0xded457 = function (_0x4825c8, _0x461b6c) {
                  ...
                  for (var _0x230642 in _0x43064f) {
                    ...
                    if (
                      _0x230642 == "font-size" &&
                      (_0x43064f[_0x230642] == "14px" || _0x43064f[_0x230642] == "20px")
                    ) {
                      continue
                    }
                  ...
                  if (!_0x2af993.parent().is(_0x19ff8b)) {
                    ...
                    if (_0x5a8d8e(_0x2af993)) {
                      ...
                      if (!_0x361d81.parent().is(_0x19ff8b)) {
                        ...
                        if (
                          !_0x361d81.is(":visible") ||
                          _0x361d81.css("opacity") == "0" ||
                          (_0x361d81.css("visibility") != "" && _0x361d81.css("visibility") != "visible")
                        ) {
                          _0x2f7273(
                            "logo_not_visible" +
                              JSON.stringify({
                          ...
                          if (_0x361d81.html() != _0x1e2f47) {
                            ...
                            var _0x29b94a =
                              _0x189e68.top >= 0 &&
                              _0x189e68.left >= 0 &&
                              _0x189e68.bottom <= _0x4c0a7c &&
                              _0x189e68.right <= _0x449cc2
                            if (_0x29b94a) {
                              _0x2f7273()
                            } else {
                              if (_0x4c0a7c < 200) {
  ...
  var _0x468e19 = function (_0x1f3c5a, _0x96ab70) {
    ...
    var _0x2ca5c3 = function (_0x56603f, _0x5d9c96) {
      ...
      for (var _0x2f74a8 in _0x1f3c5a.seg) {
        ...
        switch (_0x5343eb[0]) {
            ...
            _0x13f873 = _0x13f873.replace(/URI="([^"]+)"/g, function (_0xbad0a1, _0x1272c8) {
              ...
              if (_0x2f6db3.length > 1) {
                if (!_0x119a00.aio && _0x119a00.isSupported) {
                  return (
                    'URI="https://storage.googleapis.com/bucket?s=' +
                    _0x28fb85 +
                    "&f=" +
                    encodeURIComponent(_0x2f6db3[1]) +
                    '"'
                  )
                }
          ...
          default:
            ...
            if (!_0x119a00.aio && _0x119a00.isSupported) {
              _0x5dc70b +=
                "https://storage.googleapis.com/bucket?s=" +
                _0x29c6e7 +
                "&p=" +
                _0x5343eb[2] +
                "&f=" +
                encodeURIComponent(_0x5343eb[1])
            } else {
              if (false && _0x119a00.test_mode && _0x119a00.isSWSupported) {
                _0x5dc70b +=
                  "https://storage.googleapis.com/bucket?s=" + _0x29c6e7 + "&f=" + encodeURIComponent(_0x5343eb[1])
              } else {
              ...
              if (_0x630082[_0x4a85aa]) {
                ...
                if (_0x34a097) {
                  if (_0x19e67a.retry >= _0x5eba2b.maxRetry) {
                    _0x58de53.callbacks.onError.call(
                      _0x58de53,
                      {
                        data: "waiting",
                        url: _0x3b36fb.url,
                    ...
                    _0x37738c.addEventListener("message", function _0x1f6fcd(_0x589d4d) {
                      ...
                      if (!_0x269ba1) {
                        setTimeout(function () {
                          ...
                          _0x58de53.retryTimeout = window.setTimeout(
                            _0x58de53.loadInternalWs.bind(_0x58de53),
                            _0x58de53.retryDelay
                          )
            ...
            if (_0x2f732e.searchParams.get("s") === _0x28fb85) {
              ...
              if (_0x1f3c5a.marker) {
                ...
                _0x37738c.addEventListener("message", function _0x26e14e(_0x47d36e) {
                  ...
                  _0x58de53.callbacks.onSuccess.call(
                    _0x58de53,
                    {
      ...
      _0x119a00.seekingFunc = function () {
        ...
        if (_0x217199 > 1) {
          ...
          _0x4b1bae = setTimeout(function () {
            ...
            new Image().src =
              "/detail/tracking/dt/hex/type/player_seek/id/" +
              _0x119a00.item.id +
              "/m/" +
              _0x113c45(_0x1f3c5a.marker) +
              "?src=" +
              encodeURIComponent(location.href) +
              "&to=" +
              encodeURIComponent(_0x44ec2c) +
              "&c=" +
              _0xfbb553
          }, 200)
        }
      ...
      _0x119a00.player.one("play", function () {
        new Image().src =
          "/detail/tracking?type=player_play&id=" +
          _0x119a00.item.id +
          "&m=" +
          encodeURIComponent(_0x1f3c5a.marker) +
          "&src=" +
          encodeURIComponent(location.href)
      })
        ...
        _0x1443e9 = setTimeout(function () {
          ...
          if (new Date().getTime() - _0x25e6b5 > 1000) {
            ...
            if (true || _0x119a00.test_mode) {
              ...
              if (
                _0x119a00.midrollMap.counter < _0x119a00.midrollMap.max_midroll &&
                _0x14e9bc - _0x119a00.midrollMap.anchor > _0x119a00.midrollMap.min_threshold
              ) {
                for (var _0x46d220 in _0x119a00.midrollMap.marker) {
                  if (!_0x119a00.midrollMap.marker[_0x46d220].stt) {
                    if (
                      _0x119a00.midrollMap.marker[_0x46d220].s < _0x4e184c &&
                      _0x4e184c < _0x119a00.midrollMap.marker[_0x46d220].e
                    ) {
